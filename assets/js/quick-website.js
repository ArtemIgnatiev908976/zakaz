...
var Layout = function () {
    ...
    function i(t) {
        $(".sidenav-toggler").removeClass("active"), $(".sidenav-toggler").data("action", "sidenav-pin"), $("body").removeClass("sidenav-pinned"), $("body").addClass("ready"), $("body").find(".sidenav-mask").remove(), $(t.data("target")).removeClass("show"), localStorage.setItem("sidenav-state", "unpinned")
    }

    var t = localStorage.getItem("sidenav-state") ? localStorage.getItem("sidenav-state") : "pinned";
    if ($(window).on({
        "load resize": function () {
            $(".sidenav-toggler").length ? $(window).width() < 1200 ? i($(".sidenav-toggler")) : "pinned" == t ? n($(".sidenav-toggler")) : "unpinned" == t && i($(".sidenav-toggler")) : $("body").addClass("ready")
        }
        ...
        switch (a) {
            case"offcanvas-open":
                o = e.data("target"), $(o).addClass("open"), $("body").append('<div class="body-backdrop" data-action="offcanvas-close" data-target=' + o + " />");
                break;
            case"offcanvas-close":
                o = e.data("target"), $(o).removeClass("open"), $("body").find(".body-backdrop").remove();
                break;
            case"aside-open":
                o = e.data("target"), e.addClass("active"), $(o).addClass("show"), $("body").append('<div class="mask-body mask-body-light" data-action="aside-close" data-target=' + o + " />");
                break;
            case"aside-close":
                o = e.data("target"), e.removeClass("active"), $(o).removeClass("show"), $("body").find(".body-backdrop").remove();
                break;
            case"omnisearch-open":
                o = e.data("target"), e.addClass("active"), $(o).addClass("show"), $(o).find(".form-control").focus(), $("body").addClass("omnisearch-open").append('<div class="mask-body mask-body-dark" data-action="omnisearch-close" data-target="' + o + '" />');
                break;
            case"omnisearch-close":
                o = e.data("target"), $('[data-action="search-open"]').removeClass("active"), $(o).removeClass("show"), $("body").removeClass("omnisearch-open").find(".mask-body").remove();
                break;
            case"search-open":
                o = e.data("target"), e.addClass("active"), $(o).addClass("show"), $(o).find(".form-control").focus();
                break;
            case"search-close":
                o = e.data("target"), $('[data-action="search-open"]').removeClass("active"), $(o).removeClass("show");
                break;
            case"sidenav-pin":
                n(e);
                break;
        ...
        var e = $("[data-offset-top]"), a = $(e.data("offset-top")).height();
    ...
    return {
        colors: {
            ...
            theme: {
                primary: t.getPropertyValue("--primary") ? t.getPropertyValue("--primary").replace(" ", "") : "#6e00ff",
                info: t.getPropertyValue("--info") ? t.getPropertyValue("--info").replace(" ", "") : "#00B8D9",
                success: t.getPropertyValue("--success") ? t.getPropertyValue("--success").replace(" ", "") : "#36B37E",
                danger: t.getPropertyValue("--danger") ? t.getPropertyValue("--danger").replace(" ", "") : "#FF5630",
                warning: t.getPropertyValue("--warning") ? t.getPropertyValue("--warning").replace(" ", "") : "#FFAB00",
                dark: t.getPropertyValue("--dark") ? t.getPropertyValue("--dark").replace(" ", "") : "#212529"
            },
    ...
    var t = document.querySelectorAll("img.svg-inject"), e = !1;
    ...
    t.length && t.each(function () {
        !function (t) {
            var e = t.children("img").attr("src"), a = t.data("bg-position") ? t.data("bg-position") : "initial",
                o = t.data("bg-size") ? t.data("bg-size") : "auto",
                n = t.data("bg-height") ? t.data("bg-height") : "100%";
            t.css("background-image", 'url("' + e + '")').css("background-position", a).css("background-size", o).css("opacity", "1").css("height", n)
        }($(this))
    })
}(), CardActions = function () {
    var t = $(".card"), o = ".card-product-actions";
    t.length && $(o).length && (t.on({
        mouseenter: function () {
            !function (t) {
                var e = t.find(o), a = e.data("animation-in");
                e.length && (e.addClass("in animated " + a), e.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
        ...
        mouseleave: function () {
            !function (t) {
                var e = t.find(o), a = e.data("animation-out");
                e.length && (e.addClass("animated " + a), e.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function () {
                    e.removeClass("in animated " + a)
                }))
            }($(this))
        }
    }))
}(), Cookies = function () {
    var t, e = $("#modal-cookies");
    e.length && (t = e, localStorage.getItem("modal_cookies") || t.modal("show"), e.on("hidden.bs.modal", function () {
        localStorage.setItem("modal_cookies", 1)
    }))
}(), CopyType = function () {
    var t, e = ".btn-type-clipboard", a = $(e);
    ...
    var t = $(".dropdown-animate"), e = $('.dropdown-submenu [data-toggle="dropdown"]');
    t.length && t.on({
    ...
    var t = $(".form-control"), e = $('[data-toggle="indeterminate"]');
    ...
    t.length && (t.on({
        "show.bs.collapse": function () {
            e.addClass("navbar-collapsed"), a.addClass("navbar-collapsed"), $("body").addClass("modal-open")
        }
    }), t.on({
        ...
        "hidden.bs.collapse": function () {
            !function (t) {
                t.removeClass("collapsing-out"), e.removeClass("navbar-collapsed-out"), a.removeClass("navbar-collapsed-out"), $("body").removeClass("modal-open")
            }(t)
        }
    }))
}(), NavbarSticky = function () {
    var t = $(".navbar-sticky"), o = 0, e = !1;
    t.length && (o = t.offset().top, $(window).on({
        scroll: function () {
            e = !0, setInterval(function () {
                e && (e = !1, function (t) {
                    var e = $(window).scrollTop(), a = t.outerHeight();
    ...
    var t = $("[data-negative-margin]");
    $(window).on({
        "load resize": function () {
            t.length && t.each(function () {
                !function (t) {
                    var e = t.find($(t.data("negative-margin"))).height();
                    console.log(e), 991 < $(window).width() ? t.css({"margin-top": "-" + e + "px"}) : t.css({"margin-top": "0"})
                }($(this))
            })
        }
    })
    ...
    var t = $(".pricing-container"), e = $(".pricing-container button[data-pricing]");
    t.length && e.on({
        click: function () {
            !function (t) {
                t.data("pricing");
                var e = t.parents(".pricing-container"), a = $("." + e.attr("class") + " [data-pricing-value]");
                t.hasClass("active") || ($("." + e.attr("class") + " button[data-pricing]").removeClass("active"), t.addClass("active"), a.each(function () {
                    var t = $(this).data("pricing-value"), e = $(this).find("span.price").text();
    ...
    var t = $(".scroll-me, [data-scroll-to], .toc-entry a"), e = window.location.hash;
    t.length && t.on("click", function () {
        !function (t) {
            var e = t.attr("href"), a = t.data("scroll-to-offset") ? t.data("scroll-to-offset") : 0,
    ...
    var t = $(".shape-container");
    $(window).on({
        "load resize": function () {
            t.length && setTimeout(function () {
                t.each(function () {
                    !function (t) {
                        var e = t.find("svg").height();
                        t.css({height: e + "px"})
                    }($(this))
                })
            }, 300)
                ...
                !function (t) {
                    ...
                    if ("fullscreen" == t.data("spotlight")) {
                        if (t.data("spotlight-offset")) {
                            var a = $("body").find(t.data("spotlight-offset")).height();
                            e = $(window).height() - a
                        } else e = $(window).height();
                        991 < $(window).width() ? t.find(".spotlight-holder").css({height: e + "px"}) : t.find(".spotlight-holder").css({height: "auto"})
                    }
                    t.imagesLoaded().done(function () {
                        t.find(".animated").each(function () {
                            var t = $(this);
                            if (!t.hasClass("animation-ended")) {
                                var e = t.data("animation-in"),
                                    a = (t.data("animation-out"), t.data("animation-delay"));
                                setTimeout(function () {
                                    t.addClass("animation-ended " + e, 100).on("webkitAnimationEnd animationend", function () {
                                        t.removeClass(e)
                                    })
                                }, a)
                            }
    ...
    void 0 !== t && null != t && google.maps.event.addDomListener(window, "load", function (t) {
        ...
        var e = new google.maps.LatLng(i, s), a = {
            zoom: l,
            scrollwheel: !1,
            center: e,
    ...
    void 0 !== t && null != t && google.maps.event.addDomListener(window, "load", function (t) {
        ...
        var e = new google.maps.LatLng(i, s),
            a = {zoom: r, scrollwheel: !1, center: e, mapTypeId: google.maps.MapTypeId.ROADMAP};
        t = new google.maps.Map(t, a);
        var o = new google.maps.Marker({
                position: e,
                map: t,
    ...
    t.length && t.each(function () {
        !function (t) {
            ...
            t.countdown(e).on("update.countdown", function (t) {
                $(this).html(t.strftime('<div class="countdown-item"><span class="countdown-digit">%-D</span><span class="countdown-label countdown-days">day%!D</span></div><div class="countdown-item"><span class="countdown-digit">%H</span><span class="countdown-separator">:</span><span class="countdown-label">hours</span></div><div class="countdown-item"><span class="countdown-digit">%M</span><span class="countdown-separator">:</span><span class="countdown-label">minutes</span></div><div class="countdown-item"><span class="countdown-digit">%S</span><span class="countdown-label">seconds</span></div>'))
            })
        }($(this))
    })
}();
    ...
    c.fn.countTo = function (d) {
        return d = d || {}, c(this).each(function () {
            var a = c.extend({}, c.fn.countTo.defaults, {
                ...
                }, d), t = Math.ceil(a.speed / a.refreshInterval), e = (a.to - a.from) / t, o = this, n = c(this), i = 0,
                s = a.from, r = n.data("countTo") || {};
...
var Counter = function () {
    ...
    var t = $('[data-toggle="date"]'), e = $('[data-toggle="datetime"]'), a = $('[data-toggle="time"]');
    t.length && t.each(function () {
        !function (t) {
            t.flatpickr({enableTime: !1, allowInput: !0})
        }($(this))
    }), e.length && e.each(function () {
        !function (t) {
            t.flatpickr({enableTime: !0, allowInput: !0})
        }($(this))
    }), a.length && a.each(function () {
        !function (t) {
            t.flatpickr({noCalendar: !0, enableTime: !0, allowInput: !0})
        }($(this))
    })
    ...
    t.length && t.each(function () {
        !function (t) {
            var e = t.find(".masonry"), o = t.find(".masonry-filter-menu"), a = o.find(".active"), n = a.data("filter"),
                i = e.imagesLoaded(function () {
                    null != n && "" != n && ("*" != n && (n = "." + n), a.addClass("active"));
                    var t = {itemSelector: ".masonry-item", filter: n};
                    i.isotope(t)
                });
            o.on("click", "a", function (t) {
                t.preventDefault();
                var e = $(this), a = $(this).attr("data-filter");
    ...
    $(document).ready(function () {
        t.length && t.each(function (t, e) {
            !function (t) {
                var e = t.find(".swiper-container"), a = t.find(".swiper-pagination"),
                    o = t.find(".swiper-button-next"), n = t.find(".swiper-button-prev"),
                    ...
                    u = e.data("swiper-items"), f = e.data("swiper-sm-items"), g = e.data("swiper-md-items"),
                    h = e.data("swiper-lg-items"), m = e.data("swiper-xl-items"), v = e.data("swiper-space-between"),
                    w = e.data("swiper-sm-space-between"), b = e.data("swiper-md-space-between"),
                    y = e.data("swiper-lg-space-between"), $ = e.data("swiper-xl-space-between");
                u = u || 1, f = f || u, g = g || f, h = h || g, m = m || h, v = v || 0, w = w || v, b = b || w, y = y || b, $ = $ || y, new Swiper(e, {
                    pagination: {
                        el: a,
                        clickable: !0,
                        type: p
                    ...
                    breakpoints: {
                        575: {slidesPerView: f, spaceBetweenSlides: w},
                        767: {slidesPerView: g, spaceBetweenSlides: b},
                        991: {slidesPerView: h, spaceBetweenSlides: y},
                        1199: {slidesPerView: m, spaceBetweenSlides: $}
                    }
                })
            }($(e))
        })
    ...
    t.length && t.each(function () {
        !function (t) {
            var e = "#" + t.attr("id"), a = (a = t.data("type-this")).split(","),
                o = new Typed(e, {strings: a, typeSpeed: 100, backSpeed: 70, loop: !0});
    ...
    t.length && t.each(function () {
        !function (t) {
            ...
            }, a = (t.data().dataset, t.data().labels, t.data().color), o = t.data().height, n = t.data().type;
            e.colors = [PurposeStyle.colors.theme[a]], e.markers.colors = [PurposeStyle.colors.theme[a]], e.chart.height = o || 350, e.chart.type = n || "line";
            var i = new ApexCharts(t[0], e);
            setTimeout(function () {
                i.render()
            }, 300)
        }($(this))
    })
}(), MonthlyEarningsChart = function () {
    var t = $("#apex-monthly-earnings");
    t.length && t.each(function () {
        !function (t) {
            var e = {
                chart: {
                ...
                stroke: {show: !1},
                series: [{name: "", data: [8e3, 3e3, 1e3, 9e3, 2e3, 3e3, 5e3]}],
                xaxis: {
                    labels: {
                        format: "MMM",
                        style: {
                ...
                dataLabels: {enabled: !1},
                tooltip: {
                    enabled: !0, x: {show: !1}, y: {
                        formatter: function (t) {
                            return "$" + t + " USD"
                        }
                    }
                }
            }, a = (t.data().dataset, t.data().labels, t.data().color), o = t.data().height;
            t.data().type, e.colors = [PurposeStyle.colors.theme[a]], e.markers.colors = [PurposeStyle.colors.theme[a]], e.chart.height = o || 350;
            var n = new ApexCharts(t[0], e);
            setTimeout(function () {
                n.render()
            }, 300)
        }($(this))
    ...
    t.length && t.each(function () {
        !function (t) {
            var e = {
                ...
                }, a = t.data().dataset, o = t.data().labels, n = t.data().color, i = t.data().height, s = t.data().type,
                r = t.data().stroke;
            e.series = [{data: a}], o && (e.labels = [o]), e.colors = [PurposeStyle.colors.theme[n]], e.chart.height = i || 35, e.chart.type = s || "line", e.stroke.width = r || 2;
            var l = new ApexCharts(t[0], e);
            setTimeout(function () {
                l.render()
            }, 300)
        }($(this))
